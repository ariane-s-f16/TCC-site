    ...
    <header>
        <div class="nav-container">
            <div class="left-nav-container">
                <div class="lg-div"><img src="public/img/logo.png" alt="Logo OPI"></div>
            ...
            <nav class="right-nav-container">
                <ul class="nav-links">
                    ...
                    <li><a href="index.php?url=sobre" class="nav-link">Sobre</a></li>
                </ul>
    ...
    <div class="auth-container">
        <div class="auth-wrapper">
            ...
            <div class="auth-header">
                ...
                <p class="main-subtitle" id="mainSubtitle">Acesse sua conta para continuar</p>
            </div>
            ...
            <div class="auth-card">
                <div class="card-header">
                    ...
                    <p class="card-description" id="cardDescription">Digite seus dados para acessar</p>
                </div>
                ...
                <div class="card-content">
                    ...
                    <form id="registerForm" class="auth-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="confisenha" name="confisenha" class="form-input" placeholder="••••••••"
                                required>
                        </div>
                    ...
                    <form id="forgotPasswordForm" class="auth-form">
                        <div class="form-group">
                            ...
                            <input type="email" id="esqueci_email" class="form-input" placeholder="seu@email.com"
                                required>
                        </div>

                        <button type="submit" class="btn-primary">
                            <span class="btn-text">Enviar Email de Recuperação</span>
                ...
                <div class="card-footer">
                    ...
                    <div class="switch-form-text">
                        <span class="switch-text" id="switchText"><a href="index.php?url=cadastrar">Não tem uma conta? <a>.</span>
                        <button type="button" class="text-link-bold" id="switchFormBtn" ><a href="index.php?url=cadastrar">Cadastre-se</a></button>
                    </div>
                </div>
            </div>
