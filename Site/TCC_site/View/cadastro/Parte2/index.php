...
<head>
    ...
    <title>Cadastro - Plataforma de Trabalhadores e Empresas</title>
        ...
        <div class="nav-container">
            ...
            <nav class="right-nav-container">
                <ul class="nav-links">
                    ...
                    <li><a href="index.php?url=empresas" class="nav-link">Empresas</a></li>
    ...
    <div class="register-container">
        <div class="register-wrapper">
            ...
            <div class="register-header">
                ...
                <p class="main-subtitle">Escolha o tipo de cadastro e preencha seus dados</p>
            </div>

            <!-- Card de Cadastro -->
            <div class="register-card">
                <!-- Seletor de Tipo de Cadastro -->
                <div class="tipo-cadastro-selector">
                    <button class="tipo-btn active" data-tipo="empresa">
                    ...
                    <button class="tipo-btn" data-tipo="profissional">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                            <circle cx="12" cy="7" r="4"></circle>
                        </svg>
                    ...
                    <button class="tipo-btn" data-tipo="contratante">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="card-content">
                    ...
                    <form id="empresaForm" class="register-form active">
                        <div class="image-uploads-section">
                            <div class="banner-upload">
                                <label for="empresaBanner" class="upload-label banner-label">
                                    <div class="upload-placeholder" id="empresaBannerPreview">
                                ...
                                <input type="file" id="empresaBanner" accept="image/*" class="file-input">
                            </div>

                            <div class="profile-upload">
                                <label for="empresaPerfil" class="upload-label profile-label">
                                    <div class="upload-placeholder circular" id="empresaPerfilPreview">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                            <circle cx="12" cy="7" r="4"></circle>
                                        </svg>
                                ...
                                <input type="file" id="empresaPerfil" accept="image/*" class="file-input">
                            </div>
                        </div>
                        ...
                        <div class="form-fields">
                            <div class="form-group">
                                ...
                                <input type="text" id="nome" name="nome" class="form-input" placeholder="Digite o nome da empresa" required>
                            </div>

                            <div class="form-group">
                                <label for="registerTel" class="form-label">Telefone</label>
                                <input type="tel" id="telefone" name="telefone" class="form-input" placeholder="(DDD) 00000-0000" required>
                            </div>

                            <div class="form-group">
                                <label for="empresaCnpj" class="form-label">CNPJ</label>
                                <input type="text" id="CNPJ"  name="CNPJ" class="form-input" placeholder="00.000.000/0000-00" required>
                            </div>

                            <div class="form-group">
                                <label for="empresaCep" class="form-label">CEP</label>
                                <input type="text" id="CEP" name="CEP" class="form-input" placeholder="00000-000" required>
                            </div>

                            <div class="form-group">
                                <div class="searchable-select">
                                    <label for="empresaAreaInput" class="form-label">Área da Empresa</label>
                                    ...
                                    <ul id="empresaAreaOptions" class="options-list hidden">
                                    ...
                                    <input type="hidden" id="empresaArea" name="empresaArea">
                                </div>
                            </div>
                        </div>

                        <button type="submit" class="btn-primary">
                            <span class="btn-text">Criar Conta como Empresa</span>
                            <span class="btn-loading" style="display: none;">Cadastrando...</span>
                        </button>
                    </form>

                    <!-- Formulário de Profissional -->
                    <form id="profissionalForm" class="register-form">
                        <div class="image-uploads-section">
                            <div class="banner-upload">
                                <label for="profissionalBanner" class="upload-label banner-label">
                                    <div class="upload-placeholder" id="profissionalBannerPreview">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                                            <circle cx="8.5" cy="8.5" r="1.5"></circle>
                                            <polyline points="21 15 16 10 5 21"></polyline>
                                ...
                                <input type="file" id="profissionalBanner" accept="image/*" class="file-input">
                            </div>

                            <div class="profile-upload">
                                <label for="profissionalPerfil" class="upload-label profile-label">
                                    <div class="upload-placeholder circular" id="profissionalPerfilPreview">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                            <circle cx="12" cy="7" r="4"></circle>
                                        </svg>
                                ...
                                <input type="file" id="profissionalPerfil" accept="image/*" class="file-input">
                            </div>
                        </div>
                        ...
                        <div class="form-fields">
                            ...
                            <div class="form-group">
                                <label for="profissionalCep" class="form-label">CEP</label>
                                <input type="text" id="CEP" class="form-input" placeholder="00000-000" required>
                            </div>

                            <div class="form-group">
                                <div class="searchable-select">
                                    <label for="profissionalAreaInput" class="form-label">Área de Atuação</label>
                                    
                                    <input 
                                        type="text" 
                                        id="profissionalAreaInput" 
                                        class="form-input" 
                                        placeholder="Digite para buscar..." 
                                        autocomplete="off"
                                        required
                                    ...
                                    <ul id="profissionalAreaOptions" class="options-list hidden">
                                        <li data-value="pedreiro">Pedreiro</li>
                                        <li data-value="pintor">Pintor</li>
                                        <li data-value="eletricista">Eletricista</li>
                                        <li data-value="encanador">Encanador</li>
                                        <li data-value="marceneiro">Marceneiro</li>
                                        <li data-value="jardineiro">Jardineiro</li>
                                        <li data-value="faxineiro">Faxineiro</li>
                                        <li data-value="desenvolvedor">Desenvolvedor</li>
                                        <li data-value="outros">Outros</li>
                                    </ul>
                                
                                    <input type="hidden" id="profissionalArea" name="profissionalArea">
                                </div>
                        ...
                        <button type="submit" class="btn-primary">
                            <span class="btn-text">Criar Conta como Profissional</span>
                            <span class="btn-loading" style="display: none;">Cadastrando...</span>
                        </button>
                    </form>

                    <!-- Formulário de Contratante -->
                    <form id="contratanteForm" class="register-form">
                        <div class="image-uploads-section">
                            <div class="banner-upload">
                                <label for="contratanteBanner" class="upload-label banner-label">
                                    <div class="upload-placeholder" id="contratanteBannerPreview">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
                                            <circle cx="8.5" cy="8.5" r="1.5"></circle>
                                            <polyline points="21 15 16 10 5 21"></polyline>
                                ...
                                <input type="file" id="contratanteBanner" accept="image/*" class="file-input">
                            </div>

                            <div class="profile-upload">
                                <label for="contratantePerfil" class="upload-label profile-label">
                                    <div class="upload-placeholder circular" id="contratantePerfilPreview">
                                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                            <circle cx="12" cy="7" r="4"></circle>
                                        </svg>
                                ...
                                <input type="file" id="contratantePerfil" accept="image/*" class="file-input">
                            </div>
                        </div>

                        <div class="form-fields">
                            <div class="form-group">
                                <label for="contratanteNome" class="form-label">Nome Completo</label>
                                <input type="text" id="nome" name="nome" class="form-input" placeholder="Digite seu nome completo" required>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="contratanteCpf" class="form-label">CPF</label>
                                <input type="text" id="CPF" name="CPF" class="form-input" placeholder="000.000.000-00" required>
                            </div>

                            <div class="form-group">
                                <label for="contratanteCep" class="form-label">CEP</label>
                                <input type="text" id="CEP" name="CEP" class="form-input" placeholder="00000-000" required>
                            </div>
                        </div>

                        <button type="submit" class="btn-primary">
                            <span class="btn-text">Criar Conta como Contratante</span>
                            <span class="btn-loading" style="display: none;">Cadastrando...</span>
                        </button>
                    </form>
                </div>
                ...
                <div class="card-footer">
                    <div class="back-to-login">
                        <span class="back-text" > <a href="index.php?url=cadastrar">Já tem uma conta?  </a></span>
                        <a href="index.php?url=entrar" class="back-link">Fazer Login</a>
                    </div>
                </div>
            </div>
