...
<head>
    ...
    <link rel="stylesheet" href="public/style12.css">
    <title>Perfil</title>
</head>
    ...
    <main class="perfil_profisional-main">
        <section class="img_fundo-card-perfil">
            ...
            <div class="card-perfil">
                <div class="top-content-card">
                    ...
                    <div class="TCC-right">
                        <button class="add_remove-favoritos">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="#2e2d37" stroke-width="2" stroke-linecap="round"
                        ...
                        <button class="compartilhar-perfil">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-share2 w-5 h-5">
        ...
        <section class="mais-informacoes">
            ...
            <div class="avaliacao">
                ...
                <div class="bottom-sess_avali">
                    <h3>Destaques</h3>
                    <div class="bottom-content-bsa">
                        <div class="recomendações">
                            <span class="recomendações-porcentagem">98%</span>
                            <p>Recomendações</p>
                        </div>

                        <div class="pontualidade">
                            <span class="pontualidade-porcentagem">95%</span>
                            <p>Pontualidade</p>
                        </div>

                        <div class="qualidade">
                            <span class="qualidade-porcentagem">97%</span>
                            <p>Qualidade</p>
                        </div>
                    </div>
                </div>
