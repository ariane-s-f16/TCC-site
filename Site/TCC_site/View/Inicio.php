...
<head>
    ...
    <style> 
        * {margin: 0; padding: 0; box-sizing: border-box;}
        ...
        text-align: center;border-radius: 10px; box-shadow: 2px 2px 8px rgba(0,0,0,0.1);}.card img {width: 100%; height: auto; border-radius: 5px;}.card button {margin-top: 10px;
        padding: 8px 12px; background-color: #04AA6D; color: white;border: none;border-radius: 5px; cursor: pointer;} .card button a {text-decoration: none; color: white;
        }
    </style>
...
<div class="carousel-container">
    <div class="carousel-track">
        ...
        <!--fim do carrosel para prestadores de serviço-->
        </body>
</html>